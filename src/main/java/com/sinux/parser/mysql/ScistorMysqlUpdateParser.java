...
import com.sinux.parser.result.ScistorUpdateResult;
import com.sinux.parser.table.ScistorTable;

public class ScistorMysqlUpdateParser  extends ScistorMysqlDeleteParser{

	public ScistorMysqlUpdateParser(SQLStatement statement) {
		super(statement);
	...
	public ScistorResult getParseResult() throws ScistorParserException {
		MySqlUpdateStatement update = (MySqlUpdateStatement) this.statement;
