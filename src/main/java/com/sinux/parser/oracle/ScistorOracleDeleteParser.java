...
//import com.alibaba.druid.sql.dialect.mysql.ast.statement.OracleUnionQuery;
...
import com.sinux.parser.result.ScistorDeleteResult;
...
public class ScistorOracleDeleteParser  extends ScistorOracleConditionParser{
	protected List<ScistorTable> tables;
	public ScistorOracleDeleteParser(SQLStatement statement) {
		super(statement);
	...
	public ScistorResult getParseResult() throws ScistorParserException {
		OracleDeleteStatement delete = (OracleDeleteStatement) this.statement;
	...
	protected void parseSubQueryCondition(SQLSelectQuery subQuery,String thisQueryAlias) throws ScistorParserException{
		if(subQuery instanceof OracleSelectQueryBlock){
			...
			if(tableSource instanceof SQLExprTableSource){
				...
				//OracleUnionQuery union = (OracleUnionQuery) subUnion.getUnion();
